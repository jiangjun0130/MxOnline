...
insert  into `courses_course`(`id`,`name`,`desc`,`detail`,`degree`,`learn_times`,`students`,`fav_nums`,`image`,`click_nums`,`add_time`,`course_org_id`,`category`,`tag`,`need_known`,`teacher_id`,`teacher_tells`) values (2,'全网最热Python3入门+进阶 更快上手实际开发','全网最热Python3入门+进阶 更快上手实际开发','全网最热Python3入门+进阶 更快上手实际开发','cj',200,12,6,'course/2018/03/python.jpg',1,'2018-03-08 09:55:00.000000',1,'','python','入门到放弃',1,'来入坑！'),(3,'Python升级3.6 强力Django+杀手级Xadmin打造在线教育平台','Python升级3.6 强力Django+杀手级Xadmin打造在线教育平台','Python升级3.6 强力Django+杀手级Xadmin打造在线教育平台','zj',0,0,0,'course/2018/03/dili.jpg',0,'2018-03-16 14:42:00.000000',1,'python','python','入门到放弃',1,'来入坑！'),(4,'（第二版）亿级流量电商详情页系统实战-缓存架构+高可用服务架构+微服务架构','（第二版）亿级流量电商详情页系统实战-缓存架构+高可用服务架构+微服务架构','（第二版）亿级流量电商详情页系统实战-缓存架构+高可用服务架构+微服务架构','gj',800,1212,123234,'course/2018/03/logo.png',7790,'2018-03-16 15:33:00.000000',3,'java','python','入门到放弃',2,'来入坑！');
...
insert  into `operation_userfavorite`(`id`,`fav_id`,`fav_type`,`add_time`,`user_id`) values (1,4,1,'2018-03-19 10:53:48.383661',1),(2,3,2,'2018-03-19 10:53:57.336011',1);
...
insert  into `orgnazation_teacher`(`id`,`name`,`work_years`,`work_company`,`work_position`,`points`,`click_nums`,`fav_nums`,`add_time`,`org_id`,`image`) values (1,'booby',10,'阿里巴巴','架构师','xxx',0,0,'2018-03-16 14:35:00.000000',1,'teacher/2018/03/dili.jpg'),(2,'中华石杉',15,'阿里巴巴','架构师','xxx',0,0,'2018-03-16 14:35:00.000000',3,'teacher/2018/03/zhao.jpg');
